...
<!--Para añadir un nuevo empleados-->
<a href="añadirEmpleado.php"><input type="button" value="Añadir empleado" id="bt1"></a>
<center>
    <table border="1" cellpadding="10px" font-family:Arial style="border-radius: 0px; border-color: black;">
        ...
        <tr>
            ...
            <?php
            //Comienza el proceso para mostrar todos los empleados
            $sql = "SELECT * FROM usuario WHERE rol=2";

            $result = mysqli_query($con, $sql);
            if ($result == null) {
                //Situación en caso que no haya empleado
                echo "No hay empleado";
            } else {
