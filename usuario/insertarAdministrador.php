...
if (buscarepe($con, $DNI) == 1) {
	...
	//Aqui se declara un else para iniciar el proceso en caso de que las contraseñas sean correctas
		...
		$insertar = "INSERT INTO usuario VALUES('','$priNom','$segNom','$priApe','$segApe','$tipIde','$DNI','$gen','$fecNac','3','$correo','$clave2','$dirCom','$tel','$imgContenido','1')";
...
$mensaje   = 'Su Registro como administrador ha sido exitoso'."\r\n".'su contraseña es'."$clave2";
