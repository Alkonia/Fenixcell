...
<a href="añadirCliente.php"><input type="button" value="Añadir cliente" id="bt1"></a>
<center>
    <table border="1" cellpadding="10px" font-family:Arial style="border-radius: 0px; border-color: black;">
        ...
        <tr>
            ...
            //Comienza el proceso para mostrar todos los clientes
            $sql = "SELECT * FROM usuario WHERE rol=1";

            $result = mysqli_query($con, $sql);
            if ($result == null) {
                //Situación en caso que no haya clientes
                echo "No hay cliente";
            } else {
