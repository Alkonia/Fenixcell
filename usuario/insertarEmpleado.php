<META HTTP-EQUIV="REFRESH" CONTENT="0;URL=../usuario/listaEmpleado.php">
<?php
...
if (buscarepe($con, $DNI) == 1) {
	...
	//Aqui se declara un else para iniciar el proceso en caso de que las contraseñas sean correctas
		...
		//Se registrara exitosamente en tal caso
		...
		$insertar = "INSERT INTO usuario VALUES('','$priNom','$segNom','$priApe','$segApe','$tipIde','$DNI','$gen','$fecNac','2','$correo','$clave2','$dirCom','$tel','$imgContenido','1')";
...
$mensaje   = 'Su Registro como empleado ha sido exitoso'."\r\n".'su contraseña es'."$clave2";
